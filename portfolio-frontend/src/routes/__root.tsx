  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link to="/" className="inline-flex items-center justify-center rounded-md bg-accent px-4 py-2 text-sm font-medium text-bg">
            Go home
          </Link>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shashwat Bhajanka — Computer Science Student & Data Analyst" },
      { name: "description", content: "Portfolio of Shashwat Bhajanka — CS student and data analyst building at the intersection of data, code, and impact." },
      { name: "author", content: "Shashwat Bhajanka" },
      { property: "og:title", content: "Shashwat Bhajanka — CS Student & Data Analyst" },
      { property: "og:description", content: "Editorial portfolio: education, experience, skills, and achievements." },
